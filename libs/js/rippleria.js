;(function(PD, window, document, undefined) {
    ...
    Rippleria.prototype._bind = function() {
        ...
        this.PDelement.bind(eventType, function(e) {
            var ink = PD("<div class='rippleria-ink'/>");
            elem.append(ink);
    ...
    Rippleria.prototype._prepare = function() {
        ...
        if(this.options.detectBrightness) {
            var r,g,b,brightness,
                colour = this.PDelement.css("background-color");
            ...
            if(colour == 'transparent') {
                ...
                colour = getParentBackground(this.PDelement.parent());
            }
            ...
            if (brightness > 150) {
                this.PDelement.addClass("rippleria-dark");
            }
        }
    };
    ...
    Rippleria.prototype._getOptionsFromElementAttributes = function() {
        ...
        PD.each(Rippleria.Defaults, function(option, val) {
            var attr = base.PDelement.attr('data-rippleria-' + option);
            if (attr != null) {
                attrs[option] = attr;
            }
        });
    ...
    PD.fn.rippleria = function(option) {
        var args = Array.prototype.slice.call(arguments, 1);

        return this.each(function() {
            var PDthis = PD(this),
                data = PDthis.data('rippleria');

            if (!data) {
                data = new Rippleria(this, typeof option == 'object' && option);
                PDthis.data('rippleria', data);
            }
